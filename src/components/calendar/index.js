...
import Events from "../../../data/calendar/EventData";
        ...
        <form onSubmit={update ? updateEvent : submitHandler}>
          <DialogContent>
            <Typography variant="h3" sx={{ mb: 2 }}>
              {update ? "Update Acara" : "Tambah Acara"}
            </Typography>
            <CustomFormLabel htmlFor="Event Title">Acaranya</CustomFormLabel>
            <CustomTextField
              id="Event Title"
              ...
              size="small"
            />
            <CustomFormLabel>Select Event</CustomFormLabel>
