...
import ApproveAppModal from "../../../../src/components/modal/approval-overtime/ApproveAppModal";
import RejectAppModal from "../../../../src/components/modal/approval-overtime/RejectAppModal";
...
const DetailOvertime = ({ id_overtime }) => {
  ...
  useEffect(async () => {
    const { data } = await axios.get(`/api/overtime/${id_overtime}`);
    setDatax(data);
  }, [setDatax]);
  ...
  return (
    <Container maxWidth="sm">
      <RejectAppModal
        ...
        type={modalType}
        datax={datax}
        checkUpliner={(data) => checkUpliner(data)}
            ...
            <>
              ...
              >
                ...
                <Typography fontWeight={700}>
                  {moment(datax.overtime_in).format("DD MMMM YYYY")}
                </Typography>
